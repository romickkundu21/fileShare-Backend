module.exports = ({emailFrom, downloadLink, size, expires}) => {
    return `
        <!doctype html>
            ...
            <body class="" style="background-color: antiquewhite; font-family: sans-serif; -webkit-font-smoothing: antialiased; font-size: 14px; line-height: 1.4; margin: 0; padding: 0; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;">
